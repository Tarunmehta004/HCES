## About
HCES 2023-24 interviewed ~2,62,000 households across India to collect information on their expenditures on food, consumable and durable commodities. The raw data is spread across 15 different files. This repo aggregates all the expenses to arrive at Monthly Per Capita Expenditure (MPCE) for each household and assigns them to a decile, separately for Rural and Urban areas, based on their relative position in the overall distribution.
